...
REPO_URL = 'https://github.com/vdranyy/tdd-python.git'

def deploy():
    site_folder = '/home/%s/sites/%s' % (env.user, env.host)
    source_folder = site_folder + '/source'
    _create_folder_structure_if_necessary(site_folder)
...
def _create_folder_structure_if_necessary(site_folder):
