...
class LoginViewTest(TestCase):
    ...
    @patch('accounts.views.authenticate')
    def test_gets_logged_in_sessions_if_authenticate_returns_a_user(self, mock_authenticate):
    ...
    @patch('accounts.views.authenticate')
    def test_does_not_logged_in_if_authenticate_returns_None(self, mock_authenticate):
        mock_authenticate.return_value = None
        self.client.post('/accounts/login', {'assertion': 'a'})
